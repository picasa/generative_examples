...
density_heatmap <- function(data, gridsize=20) {
  density_matrix <- with(data, MASS::kde2d(x, y, n=gridsize))$z
}
...
# export
saveRDS(data_set, file="data/attractor_set.rds", compress="gzip")
...
# TODO cluster scatterplots or heatmaps based on 2D point density distribution
