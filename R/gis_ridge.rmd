...
plot_ridge <- data_ridge %>%
  ggplot(aes(xn, zn)) +
  geom_line(aes(group = y_rank), alpha = 0.6, size = 0.2) +
  geom_line(
...
ggsave(
  plot_ridge, file = "R/figures/gis/ridge_heric_00.png",
  dpi=300, width=format$a3[2], height = format$a3[1],
  scale=1, units="mm")

ggsave(
  plot_ridge, file = "R/figures/gis/svg/ridge_heric_00.svg",
...
box <- buffer_rectangle(
  point, size = 8000, y_shift = -4000, x_shift = 0,
  orientation="v")
...
ggsave(
  plot_ridge, file = "R/figures/gis/ridge_arves_00.png",
  dpi=300, width=format$a3[2], height = format$a3[1],
  scale=1, units="mm")

ggsave(
  plot_ridge, file = "R/figures/gis/svg/ridge_arves_00.svg",
